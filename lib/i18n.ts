...
disclaimer: 'ZeroOrigin is an experimental project. Nothing on this website should be treated as financial advice.',
  ...
  pl: {
    ...
    cta: 'Śledź budowę',
    heroKicker: 'ZeroOrigin Lab',
 heroTitle: 'Budowanie czegoś realnego — od zera.',
heroText: 'Długoterminowy publiczny eksperyment badający, czy cyfrowa społeczność może przekształcić się w realną wartość.',
heroButton: 'Poznaj wizję',
secondaryButton: 'Obserwuj na X',
definitionTitle: 'Czym jest ZeroOrigin?',
definitionText: 'ZeroOrigin to długoterminowy eksperyment oparty na prostym, ale ambitnym pytaniu: czy internetowa społeczność może rozwinąć się w coś zdolnego tworzyć realną wartość? Projekt łączy technologię, kulturę automotive i cyfrową koordynację, sprawdzając, czy idee, ludzie i długoterminowe myślenie mogą z czasem stać się czymś namacalnym. Bez drogi na skróty. Bez sztucznych obietnic. Po prostu budowanie — krok po kroku.',
missionTitle: 'Długoterminowa wizja',
missionText: 'Wizja ZeroOrigin jest świadomie ambitna. Jednym z przyszłych kierunków projektu jest sprawdzenie, czy społeczność powstała cyfrowo może z czasem wspierać realną produkcję — również koncepcje automotive inspirowane pojazdami, które nie są już produkowane. Celem nie jest krótkoterminowy hype. Celem jest długoterminowe tworzenie. Najpierw zaufanie, konsekwencja i społeczność.',
whyTitle: 'Dlaczego warto obserwować od początku?',
whyText: 'Bo rzeczy, które mają znaczenie, wymagają czasu. ZeroOrigin jest budowany publicznie — krok po kroku. Wczesny etap nie polega na hype. Polega na obserwowaniu, jak idea startująca od zera może z czasem rozwinąć się w coś znacznie większego. Niektórzy będą obserwować. Niektórzy dołączą. Niektórzy mogą kiedyś pomóc kształtować kolejny etap.',
tokenTitle: 'Przyszła warstwa cyfrowa',
tokenText: 'ZeroOrigin nie startuje z podejściem token-first. Z czasem cyfrowe systemy uczestnictwa — w tym przyszłe mechanizmy utility i koordynacja oparta na tokenie — mogą stać się częścią ekosystemu wspierającą dostęp, udział, rozwój i przyszłe możliwości. Nic na siłę. Nic obiecanego z góry.',
physicalTitle: 'Kierunek fizyczny',
physicalText: 'ZeroOrigin zachowuje długoterminowe zainteresowanie tworzeniem w świecie rzeczywistym. Automotive i mobilność pozostają częścią wczesnego kierunku, ale nie są ograniczeniem. Szerszym celem jest sprawdzenie, czy cyfrowa koordynacja może z czasem pomóc kształtować fizyczne produkty, koncepcje produkcji i namacalne rezultaty.',
publicTitle: 'Budowane publicznie',
publicText: 'ZeroOrigin rozpoczął się jako niezależny, długoterminowy eksperyment. Budowany przez jedną osobę, wspierany nowoczesnymi narzędziami AI i rozwijany publicznie krok po kroku. Wizja zaczyna się mało — ale jest zaprojektowana tak, aby z czasem mogła rosnąć przez społeczność, współtwórców i wspólną ambicję. To, co zaczyna się od jednego buildera, może kiedyś zaangażować wielu.',
roadmapTitle: 'Roadmapa',
    roadmapIntro: 'Roadmapa jest celowo realistyczna. ZeroOrigin rośnie przez widoczne kroki, a nie sztuczne obietnice.',
    roadmap: [
  { phase: 'Faza 01', title: 'Fundament', text: 'Strona, identyfikacja, kanały publiczne, pierwsza narracja i pierwsze sygnały społeczności.' },
  { phase: 'Faza 02', title: 'Społeczność', text: 'Regularne aktualizacje, pierwsi obserwujący, feedback i publiczna rozmowa o kierunku.' },
  { phase: 'Faza 03', title: 'Koordynacja', text: 'Badanie cyfrowych systemów uczestnictwa, mechanik dostępu, koncepcji utility i przyszłej koordynacji opartej na tokenie.' },
